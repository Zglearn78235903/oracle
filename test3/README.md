## 实验三:创建分区表
### 实验目的：
            -掌握分区表的创建方法，掌握各种分区方法的使用场景
### 第一步：表空间的创建
```sql
ALTER USER zhonggang QUOTA UNLIMITED ON USERS;
ALTER USER zhonggang QUOTA UNLIMITED ON USERS02;
ALTER USER zhonggang QUOTA UNLIMITED ON USERS03;
```
